...
<!-- Explain the problem, approach, and user-visible result. / 说明问题、方案和用户可见结果。 -->
...
- Affected layers / 影响层级:
- Cross-repository version requirements / 跨仓库版本要求:
- Data migration or rollback / 数据迁移或回滚:
- Security, privacy, licensing, or installer impact / 安全、隐私、许可证或安装包影响:

## Verification / 验证

<!-- List only commands and packaged-desktop scenarios actually run. / 只列出实际运行的命令和桌面安装版场景。 -->
...
<!-- Add sanitized before/after screenshots for UI changes. / UI 变更请提供脱敏的前后截图。 -->

## Checklist / 检查清单

- [ ] The change contains one focused, reviewable unit. / 改动聚焦且便于审查。
- [ ] Tests cover behavior changes and all listed checks passed. / 行为变化已有测试且所列检查通过。
