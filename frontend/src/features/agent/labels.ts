...
const toolDescriptions: Record<string, string> = {
  ...
  'tasks.create': '创建 Markdown 任务，可选配置一次性或 Cron 循环 Agent 调度。',
  'tasks.update': '更新任务 Markdown、状态、截止时间或 Agent 调度。',
  'tasks.list': '列出任务及 Agent 调度的下次/最近运行状态。',
  'tasks.read': '根据任务 ID 读取 Markdown 内容与完整调度参数。',
